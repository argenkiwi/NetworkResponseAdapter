...
public class MoshiApplicationTest : DescribeSpec({
    ...
    it("should parse empty body as null") {
        val app = TestApplication(service)
    ...
    it("should parse empty body as null for deferred methods too") {
        val app = TestApplication(service)
        ...
        response.shouldBeInstanceOf<NetworkResponse.Success<GenericErrorResponse>>()
        response.body shouldBe null
        response.code shouldBe 204
    }
})
